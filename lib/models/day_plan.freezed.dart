...
class _$DayPlanImpl implements _DayPlan {
  const _$DayPlanImpl(
      {required this.date, required this.weekday, required this.menu});
  ...
  @override
  String toString() {
    return 'DayPlan(date: $date, weekday: $weekday, menu: $menu)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, date, weekday, menu);
